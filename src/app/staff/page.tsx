...
export default async function PublicStaffPage() {
  ...
  if (staffList.length === 0) {
    departments = [
      { id: 'd1', nameTh: 'สำนักงานผู้อำนวยการ', code: 'DIR' },
      { id: 'd2', nameTh: 'กลุ่มบริหารวิชาการ', code: 'ACAD' },
      { id: 'd3', nameTh: 'กลุ่มสาระการเรียนรู้วิทยาศาสตร์และเทคโนโลยี', code: 'SCI' },
      { id: 'd4', nameTh: 'กลุ่มสาระการเรียนรู้คณิตศาสตร์', code: 'MATH' },
      { id: 'd5', nameTh: 'กลุ่มบริหารทั่วไปและอาคารสถานที่', code: 'GEN' },
    ];
    staffList = [
      {
        id: 's1',
